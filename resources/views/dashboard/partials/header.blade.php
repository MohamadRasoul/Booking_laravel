    ...
    <div class="m-0 header-wrapper row">
        ...
        <div class="col-auto p-0 header-logo-wrapper">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                                                                src="{{ asset('dashboard/assets/images/logo/logo.png') }}"
                                                                alt=""></a></div>
            ...
            <ul class="nav-menus">
                                ...
                                <div class="front">
                                    <ul class="droplet-dropdown bookmark-dropdown">
                                        <li class="gradient-primary"><i data-feather="star"></i>
                                            <h6 class="mb-0 f-18">Bookmark</h6>
                                        </li>
                                        <li>
                                            <div class="row">
                    ...
                    <ul class="cart-dropdown onhover-show-div">
                        ...
                        <li class="mt-0">
                            <div class="media"><img class="img-fluid rounded-circle me-3 img-60"
                                                    src="{{ asset('dashboard/assets/images/ecommerce/01.jpg') }}"
                                                    alt="">
                        ...
                        <li class="mt-0">
                            <div class="media"><img class="img-fluid rounded-circle me-3 img-60"
                                                    src="{{ asset('dashboard/assets/images/ecommerce/03.jpg') }}"
                                                    alt="">
                                <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                                    <p>Yellow(#fcb102)</p>
                                    <div class="qty-box">
                        ...
                        <li>
                            <div class="total">
                                <h6 class="mt-0 mb-2 text-muted">Order Total : <span
                                            class="f-right f-20">$598.00</span></h6>
                            </div>
                        </li>
                        <li><a class="mb-2 btn btn-block w-100 btn-primary view-cart" href="cart.html">Go to shoping
                                                                                                       bag</a><a
                ...
                <li class="onhover-dropdown"><i data-feather="message-square"></i>
                    <ul class="chat-dropdown onhover-show-div">
                        <li><i data-feather="message-square"></i>
                            <h6 class="mb-0 f-18">Message Box </h6>
                        </li>
                        <li>
                            <div class="media"><img class="img-fluid rounded-circle me-3"
                                                    src="{{ asset('dashboard/assets/images/user/1.jpg') }}" alt="">
                        ...
                        <li>
                            <div class="media"><img class="img-fluid rounded-circle me-3"
                                                    src="{{ asset('dashboard/assets/images/user/2.jpg') }}" alt="">
                                <div class="status-circle online"></div>
                        ...
                        <li>
                            <div class="media"><img class="img-fluid rounded-circle me-3"
                                                    src="{{ asset('dashboard/assets/images/user/4.jpg') }}" alt="">
                ...
                <li class="p-0 profile-nav onhover-dropdown me-0">
                    <div class="media profile-media"><img class="b-r-10"
                                                          src="{{ asset('dashboard/assets/images/dashboard/profile.jpg') }}"
                                                          alt="">
                    ...
                    <ul x-data class="profile-dropdown onhover-show-div">
                        <li><a href="#"><i data-feather="user"></i><span>Account </span></a></li>
                        <li><a href="#"><i data-feather="mail"></i><span>Inbox</span></a></li>
                        <li><a href="#"><i data-feather="file-text"></i><span>Taskboard</span></a></li>
                        <li><a href="#"><i data-feather="settings"></i><span>Settings</span></a></li>
                        <li>
                            <a href="" x-on:click.prevent="$refs.logoutForm.submit()">
                                <i data-feather="log-in"> </i>
                                <span>Log out</span>
                            </a>
                        </li>

                        <form method="post" hidden x-ref="logoutForm" action="{{ route('logout') }}">
                            @csrf
