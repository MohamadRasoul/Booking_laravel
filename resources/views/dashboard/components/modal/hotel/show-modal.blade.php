...
<div class="modal fade modal-bookmark" id="showModal_{{ $hotel->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="avatar">
                                <img class="b-r-8"
                                    style=" width: 70px;
                                            ...
                                            object-fit: cover;
                                                                            "
                                    src="{{ $hotel->getFirstMediaUrl('Hotel') }}" alt="#">
                            </div>
                            <div class="m-l-20 media-body align-self-center">
                                <h4 class=" mt-2 user-name" style="">{{ $hotel->name }}</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="product-page-width">
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $hotel->placeContact->about }}</td>
                            </tr>
                            <tr>
                                <td><b>Address &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b>
                                </td>
                                <td class="txt-success">{{ $hotel->placeContact->address }}</td>
                            </tr>
                            <tr>
                                <td><b>Phone Number &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>{{ $hotel->placeContact->open_at->format('H:i') }}</td>
                            </tr>
                            <tr>
                                <td><b>Close at &nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;</b>
                                </td>
                                <td>{{ $hotel->placeContact->close_at->format('H:i') }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach ($hotel->placeContact->open_days as $openDay)
                                        @switch($openDay)
                        ...
                        <div class="product-icon">
                            <ul class="product-social">
                                <li class="d-inline-block"><a target="_blank"
                                        href={{ $hotel->placeContact->facebook_url }}>
                                        <i class="fa fa-facebook"></i></a>
                                </li>
                                <li class="d-inline-block"><a target="_blank"
                                        href={{ $hotel->placeContact->instagram_url }}><i
