                    ...
                    <div class="mb-3">
                        ...
                        <select class="js-example-placeholder-multiple col-sm-12" multiple="multiple"
                            ...
                            @foreach ($daysOfWeek as $keyDay => $day)
                                <option
                                    @selected(!!Arr::first(old('open_days') ?? $clinic->placeContact->open_days, fn($el) => $el == $keyDay)) value={{ $keyDay }}>
                                    {{ $day }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-3 mt-0 p-r-0 col-md-12">
                        ...
                        <select class="form-select" aria-label="select example" name="clinic_specialization_id">
                            ...
                            @foreach ($clinicSpecializations as $clinicSpecialization)
                                <option
                                    @selected((int) $clinicSpecialization->id == (int) $clinic->clinic_specialization_id) value={{ $clinicSpecialization->id }}>
                        ...
                        <div class="mb-3 mt-0 p-r-0 col-md-6">
                            ...
                            <select class="form-select" aria-label="select example" name="city_id">
                                ...
                                @foreach ($cities as $city)
                                    <option
                                        @selected($city->id == $clinic->city_id) value={{ $city->id }}>{{ $city->name }}
                                    </option>
                                @endforeach
                            </select>
