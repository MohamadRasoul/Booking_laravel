@props(['daysOfWeek', 'users', 'cities', 'clinicSpecializations'])


<div class="modal fade modal-bookmark" id="addClinicModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">

    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2">Add Clinic </h5>
                <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form-bookmark " action="{{ route('clinic.store') }}" method='post'
                    ...
                    <div class="row m-0 col-md-12">
                        ...
                        <div class="mb-3 mt-0 p-r-0 col-md-6">
                            ...
                            <input class="form-control" type="number" name='session_duration'
                                value="{{ old('session_duration') }}" required="">
