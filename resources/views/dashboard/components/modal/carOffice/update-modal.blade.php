...
<div class="modal fade modal-bookmark"
     id="editCarOfficeModal_{{ $carOffice->id }}" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form
                    ...
                    <div class="mb-3">
                        <label class="col-form-label"
                               for="recipient-name">About</label>
                    ...
                    <div class="mb-3">
                        <label class="col-form-label"
                               for="recipient-name">Address</label>
                        <input class="form-control" type="text"
                               name='address'
                    ...
                    <div class="row m-0 col-md-12">
                        ...
                        <div class="mb-3 mt-0  p-l-0 col-md-6">
                            <label class="col-form-label"
                                   for="recipient-name">Latitude</label>
                            <input class="form-control" type="text"
                                   name='latitude'
                        ...
                        <div class="mb-3 mt-0 p-r-0 col-md-6">
                            <label class="col-form-label"
                                   for="recipient-name">Longitude</label>
                            <input class="form-control" type="text"
                                   name='longitude'
                    ...
                    <div class="mb-3">
                        ...
                        <select
                            ...
                            multiple="multiple" name="open_days[]"
                        >
                            @foreach($daysOfWeek as $keyDay => $day)

                                <option
                                    @selected(!!Arr::first(old('open_days') ?? $carOffice->placeContact->open_days, fn($el) => ($el == $keyDay)))
                                    value={{$keyDay}}>
                                    {{$day}}
                                </option>
                            @endforeach
                    ...
                    <div class="row m-0 col-md-12">
                        ...
                        <div class="mb-3 mt-0 p-r-0 col-md-6">
                            <label class="col-form-label"
                                   for="recipient-name">Instagram</label>
                            <input class="form-control" type="text"
                                   name='instagram_url'
                        ...
                        <div class="mb-3 mt-0  p-l-0 col-md-6">
                            ...
                            <select class="form-select"
                                ...
                                @foreach($users as $user)
                                    <option
                                        @selected($user->id = $carOffice->user_id)
                        ...
                        <div class="mb-3 mt-0 p-r-0 col-md-6">
                            ...
                            <select class="form-select"
                                ...
                                @foreach($cities as $city)
                                    <option
                                        @selected($city->id = $carOffice->city_id)
