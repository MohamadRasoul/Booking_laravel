@props(['daysOfWeek', 'users', 'cities', 'tableTypes'])


<div class="modal fade modal-bookmark" id="addRestaurantModal" tabindex="-1" role="dialog"
     aria-labelledby="exampleModalLabel" aria-hidden="true">

    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2">Add Restaurant</h5>
                <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form-bookmark " action="{{ route('restaurant.store') }}" method='post'
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="validationTextarea" name='about' required="">
                                                    {{ old('about') }}
                                                </textarea>
                    ...
                    <div class="row m-0 col-md-12">
                        ...
                        <div class="mb-3 mt-0  p-l-0 col-md-6">
                            ...
                            <input class="form-control" type="time" name='open_at' value="{{ old('open_at') }}"
                                   required="">
                            @error('open_at')
                        ...
                        <div class="mb-3 mt-0 p-r-0 col-md-6">
                            ...
                            <input class="form-control" type="time" name='close_at' value="{{ old('close_at') }}"
                                   required="">
                            @error('close_at')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="js-example-placeholder-multiple col-sm-12" multiple="multiple" name="open_days[]"
                                required="">

                            @foreach ($daysOfWeek as $keyDay => $day)
                                <option
                                    @selected(!!Arr::first(old('open_days', []), fn($el) => $el == $keyDay)) value={{ $keyDay }}>{{ $day }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-3">
                        ...
                        <select class="js-example-placeholder-multiple col-sm-12" multiple="multiple"
                            ...
                            @foreach ($tableTypes as $tableType)
                                <option
                                    @selected(!!Arr::first(old('table_types', []), fn($el) => $el == $tableType->id)) value={{ $tableType->id }}>{{ $tableType->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="row m-0 col-md-12">
                        ...
                        <div class="mb-3 mt-0  p-l-0 col-md-6">
                            ...
                            <select class="form-select" required="" aria-label="select example" name="user_id">
                        ...
                        <div class="mb-3 mt-0 p-r-0 col-md-6">
                            ...
                            <select class="form-select" required="" aria-label="select example" name="city_id">
