<x-dashboard-layout::dashboard title="index">
    <div class="page-body">
                            ...
                            <div class="m-0 row">
                                <div class="p-0 col-xl-3 earning-content">
                                    <div class="m-0 row chart-left">
                                        ...
                                        <div class="p-0 col-xl-12 left-btn"><a class="btn btn-gradient">Summary</a>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="button btn btn-danger">Pending<i
                                                                class="fa fa-clock-o ms-2"></i></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <div class="header-top">
                                ...
                                <div class="card-header-right-icon">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="dropdownMenuButton"><a class="dropdown-item"
                                                href="#">Year</a><a class="dropdown-item"
                    ...
                    <div class="card chat-default">
                        ...
                        <div class="card-body chat-box">
                            <div class="chat">
                                <div class="media left-side-chat">
                                    <div class="media-body d-flex">
                                        <div class="img-profile"> <img class="img-fluid"
                                                src="../assets/images/user.jpg" alt="Profile">
                                        </div>
                                        <div class="main-chat">
                                ...
                                <div class="media right-side-chat">
                                    <div class="media-body text-end">
                                        <div class="message-main pull-right"><span class="mb-0 loader-span text-start"
